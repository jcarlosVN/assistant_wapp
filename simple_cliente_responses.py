...
def read_whatsapp_messages(phone_number: str, limit: int = 10) -> bool:
    ...
    server_command = [
        r"C:\Users\jeanc\iCloudDrive\Python\Wapp_mcp_test2\whatsapp-mcp\wapp_env\Scripts\uv.exe",
        "--directory",
        r"C:\Users\jeanc\iCloudDrive\Python\Wapp_mcp_test2\whatsapp-mcp\whatsapp-mcp-server",
        "run",
        "main.py"
    ]
